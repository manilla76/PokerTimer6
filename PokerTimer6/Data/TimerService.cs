...
public class TimerService : ITimerService, IDisposable
{
    ...
    private EventHandler<TimerEventArgs>? _onTimerChangedHandler;
    ...
    public TimerService()
    {
        _onTimerChangedHandler = async (o, e) => await CalculateDisplayValue();
        OnTimerChanged += _onTimerChangedHandler;
    ...
    public void Dispose()
    {
        ...
        if (_onTimerChangedHandler is not null)
        {
            OnTimerChanged -= _onTimerChangedHandler;
            _onTimerChangedHandler = null;
        }
    }
}
